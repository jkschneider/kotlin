...
class PreliminaryLoopVisitor extends JetTreeVisitor<Void> {
    ...
    public DataFlowInfo clearDataFlowInfoForAssignedExpressions() {
        return clearDataFlowInfoForAssignedExpressions(context.dataFlowInfo);
    }

    public DataFlowInfo clearDataFlowInfoForAssignedExpressions(DataFlowInfo dataFlowInfo) {
